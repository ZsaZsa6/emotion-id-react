    ...
    if (!this.props.challenge) {
      ...
      return (
        <Challenge
          ...
          dispatchCreateAnswer={this.props.dispatchCreateAnswer}
        />
      );
    }
  };
...
const mapStateToProps = (state, { match }) => {
  return {
    ...
    challenge: state.challenges.list.find(
...
const mapDispatchToProps = (dispatch, { match }) => ({
  ...
  dispatchCreateAnswer: (answer) =>
    dispatch(createAnswer(answer, match.params.username)),
});
